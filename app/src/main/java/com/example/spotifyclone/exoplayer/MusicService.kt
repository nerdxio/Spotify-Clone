...
import com.example.spotifyclone.exoplayer.callback.MusicPlaybackPreoarer
...
class MusicService : MediaBrowserServiceCompat() {
    ...
    override fun onCreate() {
        ...
        //when click on notification service on the app
        ...
        val musicPlaybackPreoarer = MusicPlaybackPreoarer(firebaseMusicSource) {
        ...
        mediaSessionConnector.setPlaybackPreparer(musicPlaybackPreoarer)
    ...
    private fun preparePlayer(
        songs: Array<MediaMetadataCompat>,
        itemToPlay: MediaMetadataCompat?,
        playNow: Boolean
    ) {
        val curSingIndex = if (currentPlayingSong == null) 0 else songs.indexOf(itemToPlay)
        exoPlayer.prepare(firebaseMusicSource.asMediaSource(dataSourceFactory))
        exoPlayer.seekTo(curSingIndex, 0L)
